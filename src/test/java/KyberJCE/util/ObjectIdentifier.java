...
public final class ObjectIdentifier implements Serializable {
    ...
    /**
     * Constructor, from an ASN.1 encoded input stream. Validity check NOT
     * included. The encoding of the ID in the stream uses "DER", a BER/1
     * subset. In this case, that means a triple { typeId, length, data }.
     *
     * <P>
    ...
    public static ObjectIdentifier of(String oidStr) throws IOException {
        return new ObjectIdentifier(oidStr);
    }
