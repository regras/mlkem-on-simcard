 ...
 *
 * A note with respect to T61/Teletex strings: From RFC 1617, section 4.1.3 and
 * RFC 5280, section 8, we assume that this kind of string will contain
...
public class DerValue {
 ...
 /*
     ...
     * additional data following the encoded datum. In case of indefinite length
     * encoded datum, the input stream must hold only one datum.
     *
    ...
    private DerInputStream init(boolean fullyBuffered, InputStream in,
        ...
        byte[] bytes = new DataInputStream(in).readAllBytes();
     ...
     * restrictions (ASCII, T61, Printable, IA5, BMP, UTF8).
     */
    ...
    /**
     * Helper routine to return all the bytes contained in the DerInputStream
 ...
 constructor, a value equivalent to "this" is returned.
     ...
     * PrintableString: A-Z, a-z, 0-9, space, apostrophe (39), left and right
     * parentheses, plus sign, comma, hyphen, period, slash, colon, equals sign,
     * and question mark.
     *
     * Characters that are *not* allowed in PrintableString include exclamation
     * point, quotation mark, number sign, dollar sign, percent sign, ampersand,
     * asterisk, semicolon, less than sign, greater than sign, at sign, left and
     * right square brackets, backslash, circumflex (94), underscore, back quote
     * (96), left and right curly brackets, vertical line, tilde, and the
     * control codes (0-31 and 127).
     *
