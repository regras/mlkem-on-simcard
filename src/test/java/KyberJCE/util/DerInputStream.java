...
public class DerInputStream {
     ...
     * skipped. If this value is false, the next data read on this stream and
     * the newly created stream will be the same.
     */
    ...
    /**
     * Get a bit string from the input stream. Padded bits (if any) will be
     * stripped off before the bit string is returned.
     */
    ...
    protected DerValue[] readVector(int startLen) throws IOException {
        ...
        if (len == 0) // return empty array instead of null, which should be
     ...
     * @param enc the encoder to use to interpret the data. Should correspond to
     * the stringTag above.
     */
