...
import KyberJCE.spec.KyberPrivateKeySpec;
import KyberJCE.spec.KyberPublicKeySpec;
    ...
    protected <T extends KeySpec>
        ...
        if (key instanceof KyberPublicKey) {
            ...
            if (KyberPublicKeySpec.class.isAssignableFrom(keySpec)) {
                KyberPublicKey kyberPubKey = (KyberPublicKey) key;
        ...
        } else if (key instanceof KyberPrivateKey) {

            if (KyberPrivateKeySpec.class.isAssignableFrom(keySpec)) {
                KyberPrivateKey kyberPrivKey = (KyberPrivateKey) key;
